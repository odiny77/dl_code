...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="../pretrain_out/exp_mini", help="模型保存根目录") # 要修改⭕️
    ...
    parser.add_argument("--data_path", type=str, default="", help="预处理后的.bin文件路径") # 要修改⭕️
    parser.add_argument('--from_weight', default='none', type=str, help="基于哪个权重训练，为none则从头开始")
    parser.add_argument('--from_resume', default=0, type=int, choices=[0, 1], help="是否自动检测&续训（0=否，1=是）")
    parser.add_argument("--use_swanlab", type=int, default=1, choices=[0, 1], help="是否使用swanlab（0=否，1=是）")
    parser.add_argument("--swanlab_project", type=str, default="SpongeBob_PRO-Pretrain", help="swanlab项目名")
    ...
    if args.eval_bench == 1:
        ...
        tokenizer = AutoTokenizer.from_pretrained('') # 要修改⭕️
